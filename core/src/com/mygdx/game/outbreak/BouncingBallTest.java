 ...
 */
public class BouncingBallTest extends InputAdapter {
    ...
    public BouncingBallTest(Viewport viewport) {
    ...
    public void update(float delta) {
        ...
        // TODO: If we're following something, calculate the difference vector between the
        // targetPosition and the ball's position
        // TODO: Set the velocity to that vector times the FOLLOW_MULTIPLIER
        if (following) {
            velocity.x = (targetPos.x - position.x) * FOLLOW_MULTIPLIER;
            velocity.y = (targetPos.y - position.y) * FOLLOW_MULTIPLIER;
        }
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        if (worldClick.dst(position) < baseRadius * radiusMultiplier) {
            ...
            targetPos.x = worldClick.x;
            targetPos.y = worldClick.y;

...
public class Player {
    ...
    public void init() {
        ...
        home.set(
                viewport.getWorldWidth() / 2 - Constants.PLAYER_WIDTH / 2,
        ...
        rectangle.set(position.x, position.y, Constants.PLAYER_WIDTH, Constants.PLAYER_HEIGHT);
    }
    ...
    public void render(ShapeRenderer renderer) {
        ...
        if (Math.abs(velocity) > Constants.STATIC_FRICTION) {
            ...
            float offset = (velocity < 0 ? Constants.PLAYER_WIDTH - 1 : 1);
            for (float i = -0.9f; i < 1.0f; i += 0.1) {
                ...
                renderer.line(
                        ...
                        Constants.PLAYER_HEIGHT / 2 + i * multiplier,
                        Color.RED,
        ...
        batch.begin();
        batch.draw(paddle, position.x, position.y, Constants.PLAYER_WIDTH, Constants.PLAYER_HEIGHT);
        batch.end();
    }
